...
#endif
#endif
#elif HAS_TELEMETRY && (!MESHTASTIC_EXCLUDE_ENVIRONMENTAL_SENSOR || !MESHTASTIC_EXCLUDE_POWER_TELEMETRY)
NullSensor max17048Sensor;
#endif
...
// in the interest of fixing this bug I'm going to follow current practice.
    ...
    if (mqtt) {
        ...
        mqtt->publish(heapTopic, heapString, false);
        ...
        mqtt->publish(wifiTopic, wifiString, false);
    }
#endif
