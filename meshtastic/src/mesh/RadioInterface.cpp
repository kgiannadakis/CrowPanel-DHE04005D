...
#elif defined(ARCH_ESP32P4) && defined(CROWPANEL_DHE04005D)
    // ESP32-P4 cannot use Arduino SPIClass for the SX1262 — MISO routing bug
    // returns 0x00 for every read. Use the IDF-native HAL on SPI3_HOST.
    // See variants/esp32p4/crowpanel_dhe04005d/CrowPanelP4Hal.h (included via -I in env).
    LockingArduinoHal *loraHal = new CrowPanelP4Hal(LORA_SCK, LORA_MISO, LORA_MOSI);
    RadioLibHAL = loraHal;
