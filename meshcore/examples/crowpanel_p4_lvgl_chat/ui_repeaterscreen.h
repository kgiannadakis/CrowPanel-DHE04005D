...
extern lv_obj_t * ui_repeaterpathbutton;
extern lv_obj_t * ui_Label_path;
...
// CLI mode widgets
extern lv_obj_t * ui_clibutton;          // 5th action button (between Neighbours and Reboot)
extern lv_obj_t * ui_Label_cli;          // its label
extern lv_obj_t * ui_repeatercliinput;   // textarea for typing CLI commands; hidden when not in CLI mode
