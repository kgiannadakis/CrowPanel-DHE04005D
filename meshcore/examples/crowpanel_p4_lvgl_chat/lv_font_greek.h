...
// "Plain" Montserrat with NO fallback chain. Use for text-heavy,
// ASCII-only widgets like the serial monitor — skips Greek and
// color-emoji lookups per character.
extern lv_font_t lv_font_plain_12;
extern lv_font_t lv_font_plain_14;
extern lv_font_t lv_font_plain_16;
