...
void mesh_set_text_header_bytes(uint8_t bytes);
void mesh_set_path_hash_bytes(uint8_t bytes);
uint8_t mesh_get_path_hash_bytes();
...
bool mesh_reset_repeater_path_by_pubkey(const uint8_t* pub_key);
